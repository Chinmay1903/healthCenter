...
<body class="bg-dark">
    <div class="container bg-white py-2 px-0 col-3 my-5">
        <div class="container p-2 row m-0">
            <div class="col"></div>
        ...
        <div class="container" style="text-align: center;">
            ...
            <p style="font-size: 16px;font-family: helvetica, 'helvetica neue', arial, verdana, sans-serif;">Hi,
                XXXXXXXXX<br>There was a request to change your password!<br>If did not make this request, just
                ignore this email.<br>Otherwise, please enter the otp:</p>
        </div>
        <div class="container p-1 "
            style=" color: #ffffff; background-color:#a5c422; width: 90%; text-align: center; font-size: 28px; font-family: roboto, 'helvetica neue', helvetica, arial, sans-serif;">
        ...
        <div class="container p-1"
            ...
            <p style="color: #a5c422; margin:0">About us<p>
                    <p>
